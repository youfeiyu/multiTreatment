...
#install.packages("multilevelMatching")
#install.packages("Matching")
library(nnet)
library(CBPS)
library(multilevelMatching)
library(Matching)
source("~/causal_functions.R")
...
# Variance for CBPS-based matching estimators can be obtained via bootstrap
...
### 12. PENCOMP (extension of Zhou et al. 2019)
